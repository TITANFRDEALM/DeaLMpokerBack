 ...
 */
final class Version20250210092109 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE picture_nft (picture_id INT NOT NULL, nft_id INT NOT NULL, INDEX IDX_E923C50FEE45BDBF (picture_id), INDEX IDX_E923C50FE813668D (nft_id), PRIMARY KEY(picture_id, nft_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
